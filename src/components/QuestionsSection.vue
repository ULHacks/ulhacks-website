<template lang="pug">
SectionWrapper#questions
	.flex-1.flex.flex-col.items-center
		.text-6xl.font-bold.text-center.mb-5 Questions
...
const questions = [
	...
	},
	{
		...
		answer:
			"Absolutely! While you are allowed to create a project on your own, we encourage you to create a team with friends, and we'll also be hosting some team-creation events at ULHacks for those who are looking to hack with a team! The maximum team size is 4 peoplThe maximum team size is 4 people.",
	},
];
